...
router.post("/publisharticle",VerifyToken,(req,res)=>{
    ...
    const {heading,body,category,imageurl,writer,status,publisheddate}= req.body;
    ...
    mysqlconnection.query(insertquery,[heading,body,category,imageurl,writer,status,publisheddate],(err,result)=>{
        ...
        if(err){
            ...
            res.json({
                "Msg":"Article Has been sent, it will be reviewed and published Shortly"
            })
        }
